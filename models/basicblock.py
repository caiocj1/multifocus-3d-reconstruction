...
class TwoConvBlock_3D(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels):
        super().__init__()
        self.conv1 = nn.Conv3d(in_channels, middle_channels, kernel_size = 3, padding=(1,1,1))
        self.bn1 = nn.BatchNorm3d(middle_channels)
        self.rl = nn.ReLU()
        self.conv2 = nn.Conv3d(middle_channels, out_channels, kernel_size = 3, padding=(1,1,1))
...
class UpConv_3D(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Conv3d(in_channels, out_channels, kernel_size = 3, padding=(1,1,1))
        self.bn2 = nn.BatchNorm3d(out_channels)
